...
const SignupSuccessfulXPath = locator.adminPageSignupSuccessfulXPath;

let DashboardTitleE, MenuDashboardE, MenuSignupE, MenuLogoutE, ClinicianTableE, CreateAccountsButtonE, DeleteAccountsButtonE,
UserTableE, ViewAccountE, SignupTitleE, FirstNameE, LastNameE, EmailE, UsernameE, PasswordE, RepeatPasswordE,
 SubmitButtonE, SignupSuccessfulE;

Page.prototype.getSignupSuccessfulE = async function() {
	SignupSuccessfulE = await this.findByXPath(SignupSuccessfulXPath);
	return SignupSuccessfulE;
