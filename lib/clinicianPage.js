...
const CurrentPrescriptionPressureXPath = locator.clinicianPagePrescriptionsCurrentPressureXPath;
const CurrentPrescriptionTimeXPath = locator.clinicianPagePrescriptionsCurrentTImeXPath;
...
GameSettingsButtonE, GameSettingsStatusE, CurrentPressureE, CurrentTimeE;

Page.prototype.getCurrentPressureE = async function () {
    CurrentPressureE = await this.findByXPath(CurrentPrescriptionPressureXPath);
    return CurrentPressureE;
}

Page.prototype.getCurrentTimeE = async function () {
    CurrentTimeE = await this.findByXPath(CurrentPrescriptionTimeXPath);
    return CurrentTimeE;
}
